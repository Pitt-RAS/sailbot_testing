...
//This is to average the data together
...
void setup() {
  ...
  // Read the WHO_AM_I register, test to see if we can reach it.
...
void loop() {
  ...
  if (readByte(MPU9250_ADDRESS, INT_STATUS) & 0x01) {  // On interrupt, check if data ready interrupt
    ...
    //This is right now a generic value but if we were to put in the gps possition and were to calculate it based on a map.
